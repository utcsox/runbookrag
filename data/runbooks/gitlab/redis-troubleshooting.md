...
###  $ git clone https://github.com/igorwwwwwwwwwwwwwwwwwwww/rdb.git
###  $ cd rdb
...
TODO e.g. rbspy, will be partially covered by <https://gitlab.com/gitlab-com/gl-infra/production-engineering/-/issues/6940>
...
see: [ban-an-IP-with-redis](ban-an-IP-with-redis.md)
...
check Redis docs for more information: <https://raw.githubusercontent.com/redis/redis/5.0/redis.conf>
...
- <https://redis.io/blog/top-redis-headaches-for-devops-replication-buffer/>
- <https://redis.io/blog/top-redis-headaches-for-devops-replication-timeouts/>
...
Per <https://gitlab.com/gitlab-com/gl-infra/observability/team/-/issues/360> there may be a script that runs periodically (hourly by default) on a redis replica, to collect 'bigkeys' output and store it for later analysis.
...
- <https://gitlab.com/gitlab-com/gl-infra/observability/team/-/issues/49>
- <https://gitlab.com/gitlab-com/gl-infra/production-engineering/-/issues/7199>
- <https://gitlab.com/gitlab-com/gl-infra/production-engineering/-/issues/9414>
